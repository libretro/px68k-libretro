...
//	TOFIX:
//	 OPN ch3 §¨æÔ§ÀPrepare§Œ¬–æ›§»§ §√§∆§∑§ﬁ§¶æ„≥≤


// ---------------------------------------------------------------------------
//	OPNA: ADPCM •«°º•ø§Œ≥ «º ˝º∞§Œ∞„§§ (8bit/1bit) §Ú•®•ﬂ•Â•Ï°º•»§∑§ §§
//	§≥§Œ•™•◊•∑•Á•Û§ÚÕ≠∏˙§À§π§Î§» ADPCM •·•‚•Í§ÿ§Œ•¢•Ø•ª•π(∆√§À 8bit •‚°º•…)§¨
//	¬øæØ∑⁄§Ø§ §Î§´§‚
//
...
uint32	OPNBase::lfotable[8];			// OPNA/B Õ—
...
// ---------------------------------------------------------------------------
//	ADPCM RAM §´§È§Œ nibble ∆…§ﬂπ˛§ﬂµ⁄§” ADPCM ≈∏≥´
//
